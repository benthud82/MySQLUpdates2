...
$sqldelete = "DELETE from fomaverage WHERE FOMAVGWHSE = 3";
...
$sqlitem = "SELECT DISTINCT concat(FOMWHSE,FOMITEM, FOMPKGU) FROM FOMRAW WHERE ISFOM = 'Y' and FOMWHSE = 3 ORDER BY FOMITEM";
...
$result1 = $conn1->prepare("SELECT concat(FOMWHSE, FOMITEM, FOMPKGU), FOMPQTY, FOMDATE FROM fomraw WHERE ISFOM = 'Y' and FOMWHSE = 3");
$result1->execute();
