...
$sqldelete = "DELETE from fomaverage WHERE FOMAVGWHSE = 6";
...
$sqlitem = "SELECT DISTINCT concat(FOMWHSE,FOMITEM, FOMPKGU) FROM FOMRAW WHERE ISFOM = 'Y' and FOMWHSE = 6 ORDER BY FOMITEM";
...
$result1 = $conn1->prepare("SELECT concat(FOMWHSE, FOMITEM, FOMPKGU), FOMPQTY, FOMDATE FROM fomraw WHERE ISFOM = 'Y' and FOMWHSE = 6");
$result1->execute();
