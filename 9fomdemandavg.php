...
$sqldelete = "DELETE from fomaverage WHERE FOMAVGWHSE = 9";
...
$sqlitem = "SELECT DISTINCT concat(FOMWHSE,FOMITEM, FOMPKGU) FROM FOMRAW WHERE ISFOM = 'Y' and FOMWHSE = 9 ORDER BY FOMITEM";
...
$result1 = $conn1->prepare("SELECT concat(FOMWHSE, FOMITEM, FOMPKGU), FOMPQTY, FOMDATE FROM fomraw WHERE ISFOM = 'Y' and FOMWHSE = 9");
$result1->execute();
