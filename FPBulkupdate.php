...
$FPBULKsql = $conn1->prepare("SELECT DISTINCT
                                A.WAREHOUSE,
                                A.ITEM_NUMBER,
                                A.PACKAGE_UNIT,
                                A.PACKAGE_TYPE,
                            ...
                            WHERE
                                WAREHOUSE = $whssel
                                    ...
                                    and ITEM_TYPE = 'ST'
                                    and CPCCONV <> 'N'
                                    and A.CUR_LOCATION $sparksbuild2filter
                            ORDER BY DAILYPICK desc
                            ");
$FPBULKsql->execute();
$FPBULKsqlarray = $FPBULKsql->fetchAll(pdo::FETCH_ASSOC);
